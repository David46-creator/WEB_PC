  ...
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-input v-model="listQuery.name" class="filter-item" clearable placeholder="学生姓名" style="width: 200px;"
                @keyup.enter.native="handleFilter"
      />
      <!--      <el-input v-model="listQuery.classId" placeholder="所属班级" style="width: 200px;" class="filter-item" clearable @keyup.enter.native="handleFilter" />-->
      <!--      <el-select v-model="listQuery.state" placeholder="学生状态" class="filter-item" style="width: 130px" clearable @keyup.enter.native="handleFilter">-->
      ...
      <!--      <el-button type="success" class="filter-item" icon="el-icon-upload" plain @click="handleTemplate">下载导入模板</el-button>-->
    ...
    >
      ...
      <!--        </template>-->
      <!--      </el-table-column>-->
      <!--      <el-table-column label="状态" prop="state" :filter-method="filterTag" :filters="[{text: '未实习', value: '未实习'},{text: '已实习', value: '已实习'}]" class-name="status-col">-->
      <!--        <template slot-scope="{row}">-->
      ...
      <el-table-column align="center" class-name="small-padding fixed-width" label=" 操作" width="230">
        <template slot-scope="{row,$index}">
          <el-tooltip content="查看就职详情" effect="dark" placement="top">
            <el-button circle icon="el-icon-s-release" type="info" @click="toOfficesRecords(row.id)"/>
          </el-tooltip>
          <el-tooltip content="查看周打卡记录" effect="dark" placement="top">
            <el-button circle icon="el-icon-s-claim" type="success" @click="toClockRecords(row.id)"/>
          </el-tooltip>
        ...
        <el-row :gutter="100">
          <el-col :span="12">
            <div class="grid-content">
              ...
              <el-form-item label="所属班级：" prop="classId">
                <el-select v-model="temp.classId" class="filter-item" placeholder="所属班级">
          ...
          <el-col :span="12">
            <div class="grid-content">
              ...
              <!--              </el-form-item>-->
              <el-form-item label="指导老师:" label-width="500px" prop="idCard">
...
<script>
import { fetchPostStudentChosenById } from '@/api/post'
...
export default {
  ...
  methods: {
    // 接口函数获取数据
    getList() {
      fetchPostStudentChosenById(this.$route.params.id).then(response => {
